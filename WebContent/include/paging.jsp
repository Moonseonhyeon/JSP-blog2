...
<c:when test="${empty param.keyword}">
	<c:set var="pagePrev" value="/blog2/board?cmd=home&page=${param.page-1}"/>
	<c:set var="pageNext" value="/blog2/board?cmd=home&page=${param.page+1}"/>
</c:when>
<c:otherwise>
	<c:set var="pagePrev" value="/blog2/board?cmd=search&page=${param.page-1}&keyword=${param.keyword}"/>
	<c:set var="pageNext" value="/blog2/board?cmd=search&page=${param.page+1}&keyword=${param.keyword}"/>
	</c:otherwise>
</c:choose> 
